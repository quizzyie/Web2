  ...
  <section class="product spad banner spad" style="margin-top: 50px;">
      <div class="container">
          ...
          <div class="row product__filter">
              <?php for($i=0;$i<count($bestSp);$i++){  ?>
              <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix hot-sales">
                  <div class="product__item">
                      <div class="product__item__pic set-bg"
                          data-setbg="<?php echo HOST_ROOT ?>/uploads/<?php echo $bestSp[$i]["img"]  ?>">
      ...
      <div class="container">
          ...
          <div class="row product__filter">
              ...
              <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals">
                  <div class="product__item">
                      <div class="product__item__pic set-bg"
                          data-setbg="<?php echo HOST_ROOT ?>/public/assets/client/img/product/product-5.jpg">
                          <ul class="product__hover">
                              <li><a href="#"><img src="<?php echo HOST_ROOT ?>/public/assets/client/img/icon/heart.png"
                                          alt=""></a></li>
                              <li><a href="#"><img
              ...
              <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix hot-sales">
                  <div class="product__item sale">
                      <div class="product__item__pic set-bg"
                          data-setbg="<?php echo HOST_ROOT ?>/public/assets/client/img/product/product-6.jpg">
                          <span class="label">Sale</span>
                          <ul class="product__hover">
                              <li><a href="#"><img src="<?php echo HOST_ROOT ?>/public/assets/client/img/icon/heart.png"
                                          alt=""></a></li>
              ...
              <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals">
                  <div class="product__item">
                      <div class="product__item__pic set-bg"
                          data-setbg="<?php echo HOST_ROOT ?>/public/assets/client/img/product/product-7.jpg">
                          <ul class="product__hover">
                              <li><a href="#"><img src="<?php echo HOST_ROOT ?>/public/assets/client/img/icon/heart.png"
                                          alt=""></a></li>
                              <li><a href="#"><img
              ...
              <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix hot-sales">
                  <div class="product__item">
                      <div class="product__item__pic set-bg"
                          data-setbg="<?php echo HOST_ROOT ?>/public/assets/client/img/product/product-8.jpg">
                          <ul class="product__hover">
                              <li><a href="#"><img src="<?php echo HOST_ROOT ?>/public/assets/client/img/icon/heart.png"
                                          alt=""></a></li>
                              <li><a href="#"><img
      ...
      <div class="container">
          ...
          <div class="row">
              <div class="col-lg-4 col-md-6 col-sm-6">
                  <div class="blog__item">
                      <div class="blog__item__pic set-bg"
                          data-setbg="<?php echo HOST_ROOT ?>/public/assets/client/img/blog/blog-1.jpg"></div>
                      <div class="blog__item__text">
                          <span><img src="<?php echo HOST_ROOT ?>/public/assets/client/img/icon/calendar.png" alt=""> 16
                              February 2020</span>
              ...
              <div class="col-lg-4 col-md-6 col-sm-6">
                  <div class="blog__item">
                      <div class="blog__item__pic set-bg"
                          data-setbg="<?php echo HOST_ROOT ?>/public/assets/client/img/blog/blog-2.jpg"></div>
                      <div class="blog__item__text">
                          <span><img src="<?php echo HOST_ROOT ?>/public/assets/client/img/icon/calendar.png" alt=""> 21
                              February 2020</span>
              ...
              <div class="col-lg-4 col-md-6 col-sm-6">
                  <div class="blog__item">
                      <div class="blog__item__pic set-bg"
                          data-setbg="<?php echo HOST_ROOT ?>/public/assets/client/img/blog/blog-3.jpg"></div>
                      <div class="blog__item__text">
                          <span><img src="<?php echo HOST_ROOT ?>/public/assets/client/img/icon/calendar.png" alt=""> 28
                              February 2020</span>
