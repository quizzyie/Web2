<div style="max-width: 1200px;margin:0 auto; ">
    ...
    <form method="POST" action="<?php echo _WEB_HOST_ROOT_ADMIN . '/contacts/post_update' ?>">
        ...
        <button type="submit" class="btn btn-primary">Cập nhập liên hệ</button>
        <p><a href="<?php echo _WEB_HOST_ROOT_ADMIN . '/contacts' ?>">Quay lại</a></p>
