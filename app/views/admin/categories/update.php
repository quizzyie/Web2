<div style="max-width: 1200px;margin:0 auto; ">
    ...
    <form method="POST" action="<?php echo _WEB_HOST_ROOT_ADMIN.'/categories/post_update' ?>">
        ...
        <button type="submit" class="btn btn-primary">Cập nhập danh mục sản phẩm</button>
