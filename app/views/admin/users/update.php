<div style="max-width: 1200px;margin:0 auto; ">
    ...
    <form method="POST" action="<?php echo _WEB_HOST_ROOT_ADMIN.'/users/post_update/' ?>">
        <div class="row">
            ...
            <div class="col-12 form-group">
                <label for="">Mật khẩu (Để trống nếu không muốn thay đổi)</label>
            ...
            <div class="col-12 form-group">
                <label for="">Nhập lại mật khẩu (Để trống nếu không muốn thay đổi)</label>
